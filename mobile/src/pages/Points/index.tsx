...
const Points = () => {
  ...
  useEffect(() => {
    ...
    loadPosition(); // this enables to use ASYNC/AWAIT inside a callback function for useEffect(callback);
  }, []);
  ...
  function handleSelectItem(id: number) {
    const isSelected = selectedItems.some(el => el === id);
    if (isSelected) {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mapContainer}>
          { !loadingPosition && (
            <MapView
              style={styles.map}
              loadingEnabled={loadingPosition}
              initialRegion={{
